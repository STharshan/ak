...
const services = [
  {
    ...
    desc: `Local tyre fitting, on your schedule.`,
    image: "/carpaint.avif",
    path: "/services/mechanical",
  },
  {
    title: "Electronic Wheel Balancing",
    desc: `We can get you back onto the road fast.​`,
    image: "/gray.avif",
    path: "/services/service",
  },
  {
    title: "Puncture Repairs",
    desc: `Puncture repairs can be done in as little as 15 minutes.`,
              ...
              >
                ...
                <div className="max-w-sm mx-auto">
                  <img
                    src={service.image}
                    alt={service.title}
                    className="absolute inset-0 w-[58%] mx-auto mt-15 h-55 object-cover"
                    onError={(e) => {
