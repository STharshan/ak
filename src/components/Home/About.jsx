...
const AboutSection = () => {
  ...
  const testimonials = [
  {
    text: "Took my car to ak and he got the job done in a few hours and advised me on what needed to get done with fair prices. Overall happy with the service and will definitely be back, highly recommended.",
    name: "Emran Ali",
  },
